...
predictor. The `_cons` row is the intercept; it's Coef. of
   5.1138 represents the average response *when all other
predictors are 0*. This is usually not interesting; how many cars weighing 0 lbs
do you know of? So we'll ignore this and consider only the other rows. The
columns are:
